...
for _m in [k for k in sys.modules if k in (
    ...
    "panels", "panels_campaigns", "panels_reports",
    "msads_providers",
)]:
    del sys.modules[_m]
...
import panels_campaigns            # noqa: F401 — right panel: campaign detail
import panels_reports              # noqa: F401 — right panel: reports + research
